...
local hats_1 = {
	["Circle"] = {
		CatalogID = "14130401546";
		AssetId = "rbxassetid://14130310770";
		AssetIdInt = 16997648006;
		TextureID = "rbxassetid://16997653796";
	};
	["lwing1"] = {
		CatalogID = "5316479641";
		AssetId = "rbxassetid://5278721954";
		AssetIdInt = 5278721954;
		TextureID = "http://www.roblox.com/asset/?id=5278777022";
	};
	["lwing2"] = {
		CatalogID = "5316549755";
		AssetId = "rbxassetid://5278721954";
		AssetIdInt = 5278721954;
		TextureID = "http://www.roblox.com/asset/?id=5316471565";
	};
	["lwing3"] = {
		CatalogID = "5316539421";
		AssetId = "rbxassetid://5278721954";
	};
	["rwing1"] = {
		CatalogID = "5268602207";
		AssetId = "rbxassetid://5254583415"
	};
	["rwing2"] = {
		CatalogID = "5268710380";
		AssetId = "rbxassetid://5254583415"
};
	["rwing3"] = {
		CatalogID = "5268555719";
		AssetId = "rbxassetid://5254583415"
	};
}
print([[SpectrumGlitcher v7 Loaded.
The super switcher.
...
(converted to a singular script by tomaspro161)
]])
...
chring = NewInstance("MeshPart", nil, {
	["Name"] = "chring",
	["MeshId"] = "rbxassetid://432993411",
	["Size"] = Vector3.new(3, 15, 15),
	["CFrame"] = CFrame.new(-7.311, 12.455, -69.05) * CFrame.fromEulerAnglesXYZ(math.rad(0), math.rad(90), math.rad(-90)),
...
chring2 = NewInstance("MeshPart", nil, {
	["Name"] = "chring",
	["MeshId"] = "rbxassetid://545588120",
	["Size"] = Vector3.new(3, 3, 1),
	["Transparency"] = 1,
	["CFrame"] = CFrame.new(-30.851, 41.228, -68.51),
	["Color"] = Color3.fromRGB(163, 162, 165),
	["Material"] = Enum.Material.Neon,
	["TextureID"] = "",
	["Anchored"] = true,
...
spball = NewInstance("MeshPart", nil, {
	["Name"] = "spball",
	["MeshId"] = "rbxassetid://991320318",
	["Size"] = Vector3.new(10, 10, 10),
	["Transparency"] = 1,
	["CFrame"] = CFrame.new(-7.311, 15.455, -69.05),
	["Color"] = Color3.fromRGB(163, 162, 165),
	["Material"] = Enum.Material.Neon,
	["TextureID"] = "",
	["Anchored"] = true,
...
Shaker = NewInstance("LocalScript", nil, {
	["Name"] = "Shaker",
	["Disabled"] = true,
	["Source"] = [[
...
function swait()
-- (Tom) I recommend this instead
-- Honestly dont know what's different yet
...
-- Shaker values that need to be instanced :P
NewInstance("NumberValue", Shaker, {
	["Name"] = "MultLength",
	["Value"] = 1,
})
NewInstance("NumberValue", Shaker, {
...
function bosschatfunc(text,color,watval)
	...
	coroutine.resume(coroutine.create(function()
		if CoreGui:FindFirstChild("Dialog")~= nil then
			CoreGui:FindFirstChild("Dialog"):Destroy()
		end
		local scrg = Instance.new("ScreenGui",CoreGui)
...
function SetAccessoryWeld(h,part0, part1, C1X,C1Y,C1Z,C1Xa,C1Ya,C1Za,C0X,C0Y,C0Z,C0Xa,C0Ya,C0Za)
	if h:FindFirstChild("AccessoryWeld") then
		local weld = h:FindFirstChild("AccessoryWeld")
		weld.Part0 = part0
		weld.Part1 = part1
		weld.C1 = CFrame.new(C1X,C1Y,C1Z)*CFrame.Angles(C1Xa,C1Ya,C1Za)
		weld.C0 = CFrame.new(C0X,C0Y,C0Z)*CFrame.Angles(C0Xa,C0Ya,C0Za)
...
local handlex = GetAccessory("Lasergunback", "Circle")
CreateMesh(handlex,"Brick",0,0,0)
local handlexweld = GetAccessoryWeld(handlex)
	SetAccessoryWeld(handlex,tors,handlex,0,-1.5,-1.05,math.rad(0),math.rad(0),math.rad(0),0,0,0,math.rad(0),math.rad(0),math.rad(0))
local valuaring = 10
for i = 0, 49 do
...
refec.Color = ColorSequence.new(Color3.fromRGB(255, 0, 0))
refec.Rate = 50
...
refec.SpreadAngle = Vector2.new(-9000, 9000)
...
local lwing1 = GetAccessory("DemonGodSword", "lwing1")
CreateMesh(handle,"Brick",0.5,0.5,0.5)
local lwing1weld = GetAccessoryWeld(lwing1) -- not sure
SetAccessoryWeld(lwing1,handle,lwing1,3,0,0,math.rad(5),math.rad(0),math.rad(12.5),0,0,0,math.rad(0),math.rad(0),math.rad(0))

wed = CreateParta(mw1,1,0,"Neon",halocolor)
wed.Transparency = 1
...
tl1.Color = ColorSequence.new(Color3.fromRGB(255, 0, 0))
tl1.Lifetime = 0.6


local lwing2 = GetAccessory("AuroraSword", "lwing2")
CreateMesh(handle,"Brick",0.5,0.5,0.5)
local lwing2weld = GetAccessoryWeld(lwing2)
SetAccessoryWeld(lwing2,handle,lwing2,4,1,0,math.rad(10),math.rad(0),math.rad(25),0,0,0,math.rad(0),math.rad(0),math.rad(0))
...
local lwing3 = GetAccessory("RainbowGodSword", "lwing3")
CreateMesh(handle,"Brick",0.5,0.5,0.5)
local lwing3weld = GetAccessoryWeld(lwing3)
SetAccessoryWeld(lwing3,handle,lwing3,4.75,2,0,math.rad(15),math.rad(0),math.rad(37.5),0,0,0,math.rad(0),math.rad(0),math.rad(0))
...
local rwing1 = GetAccessory("VoidLordSword", "rwing1")
CreateMesh(handle,"Brick",0.5,0.5,0.5)
local rwing1weld = GetAccessoryWeld(rwing1)
SetAccessoryWeld(rwing1,handle,rwing1,-3,0,0,math.rad(5),math.rad(0),math.rad(-12.5),0,0,0,math.rad(0),math.rad(0),math.rad(0))
...
local rwing2 = GetAccessory("CorruptLordSword", "rwing2")
CreateMesh(handle,"Brick",0.5,0.5,0.5)
local rwing2weld = GetAccessoryWeld(rwing2)
SetAccessoryWeld(rwing2,handle,rwing2,-4,1,0,math.rad(10),math.rad(0),math.rad(-25),0,0,0,math.rad(0),math.rad(0),math.rad(0))
wed = CreateParta(mw2,0,0,"Neon",halocolor)
CreateMesh(wed,"Wedge",0.05,0.5,0.5)
...
tr2.Color = ColorSequence.new(Color3.new(1, 0, 0))
tr2.Lifetime = 0.6

local rwing3 = GetAccessory("DemonLordSword", "rwing3")
CreateMesh(handle,"Brick",0.5,0.5,0.5)
local rwing3weld = GetAccessoryWeld(rwing3)
SetAccessoryWeld(rwing3,handle,rwing3,-4.75,2,0,math.rad(15),math.rad(0),math.rad(-37.5),0,0,0,math.rad(0),math.rad(0),math.rad(0))
...
function FaceMouse()
	...
	return {
		...
		Vector3.new(mouse.Hit.Position.X, mouse.Hit.p.y, mouse.Hit.p.z)
	}
end
...
local ignoremeplezyesyesyesy = "true"
if ignoremeplezyesyesyesy == "true" then

	local Core = NewInstance("Model", nil, {
		["Name"] = "newCORE",
		["Scale"] = 1,
		["Origin"] = CFrame.new(-16.082, 22.589, -80.071),
	})
	local weldp = NewInstance("Part", Core, {
		-- also might be reffered as the "root part"
		["Name"] = "Weld",
		["Transparency"] = 1,
		["Size"] = Vector3.new(2, 2, 1),
		["Color"] = Color3.fromRGB(163, 162, 165),
		["CFrame"] = CFrame.new(-16.082, 22.589, -80.071),
		["CanCollide"] = false,
		["CanTouch"] = false,
		["CastShadow"] = false,
	}) 
	local cc1 = NewInstance("MeshPart", Core, {
		["MeshId"] = "rbxassetid://45428961",
		["Material"] = Enum.Material.Neon,
		...
		["Transparency"] = 0,
		["Name"] = "CORE",
		["Size"] = Vector3.new(0.349, 15.169, 0.349),
		["CFrame"] = CFrame.new(-16.082, 22.971, -80.071),
		["CastShadow"] = false,
		["CanCollide"] = false,
		["CanTouch"] = false,
	})
	local cc2 = NewInstance("MeshPart", Core, {
		["MeshId"] = "rbxassetid://45428961",
		["Material"] = Enum.Material.Neon,
		...
		["Transparency"] = 0,
		["Name"] = "CORE2",
		["Size"] = Vector3.new(0.469, 15.159, 0.499),
		["CFrame"] = CFrame.new(-16.082, 22.971, -80.071),
		["CastShadow"] = false,
		["CanCollide"] = false,
		["CanTouch"] = false,
	...
	local cc1mot = NewInstance("Motor", cc1, {
		["Name"] = "mot",
		["C0"] = CFrame.new(0, 0, 0),
		["C1"] = CFrame.new(0, 0.383, 0),
		["MaxVelocity"] = 0,
		["DesiredAngle"] = 0,
		["Part0"] = cc1,
		["Part1"] = weldp,
	})
	local cc2mot = NewInstance("Motor", cc2, {
		["Name"] = "mot",
		["C0"] = CFrame.new(0, 0, 0),
		["C1"] = CFrame.new(0, 0.383, 0),
		["MaxVelocity"] = 0,
...
Humanoid.Name = "SPECTRUMGLITCHER"
